...
printf '\nnvcc -arch=sm_60 hello1.cu\n'
nvcc -arch=sm_60 hello1.cu
printf '\n./a.out\n'
./a.out

printf '\nnvcc -arch=sm_60 hello2.cu\n'
nvcc -arch=sm_60 hello2.cu
printf '\n./a.out\n'
./a.out

printf '\nnvcc -arch=sm_60 hello3.cu\n'
nvcc -arch=sm_60 hello3.cu
printf '\n./a.out\n'
./a.out

printf '\nnvcc -arch=sm_60 hello4.cu\n'
nvcc -arch=sm_60 hello4.cu
printf '\n./a.out\n'
./a.out

printf '\nnvcc -arch=sm_60 hello5.cu\n'
nvcc -arch=sm_60 hello5.cu
printf '\n./a.out\n'
./a.out
...
printf '\nnvcc -arch=sm_60 add1.cu\n'
nvcc -arch=sm_60 add1.cu
printf '\n./a.out\n'
./a.out

printf '\nnvcc -arch=sm_60 add2wrong.cu\n'
nvcc -arch=sm_60 add2wrong.cu
printf '\n./a.out\n'
./a.out

printf '\nnvcc -arch=sm_60 add3if.cu\n'
nvcc -arch=sm_60 add3if.cu
printf '\n./a.out\n'
./a.out
...
printf '\nnvcc -arch=sm_60 add4check_api.cu\n'
nvcc add4check_api.cu
printf '\n./a.out\n'
./a.out

printf '\nnvcc -arch=sm_60 add5check_kernel.cu\n'
...
printf '\nnvcc -arch=sm_60 thrust_scan_vector.cu\n'
nvcc -arch=sm_60 thrust_scan_vector.cu
printf '\n./a.out\n'
./a.out

printf '\nnvcc -arch=sm_60 thrust_scan_pointer.cu\n'
nvcc -arch=sm_60 thrust_scan_pointer.cu
printf '\n./a.out\n'
./a.out

printf '\nnvcc -arch=sm_60 -lcublas cublas_gemm.cu\n'
nvcc -arch=sm_60 -lcublas cublas_gemm.cu
printf '\n./a.out\n'
./a.out

printf '\nnvcc -arch=sm_60 -lcusolver cusolver.cu\n'
nvcc -arch=sm_60 -lcusolver cusolver.cu
printf '\n./a.out\n'
./a.out

printf '\nnvcc -arch=sm_60 -lcurand curand_host1.cu\n'
nvcc -arch=sm_60 -lcurand curand_host1.cu
printf '\n./a.out>x1.txt\n'
./a.out>x1.txt

printf '\nnvcc -arch=sm_60 -lcurand curand_host2.cu\n'
nvcc -arch=sm_60 -lcurand curand_host2.cu
printf '\n./a.out>x2.txt\n'
./a.out>x2.txt
