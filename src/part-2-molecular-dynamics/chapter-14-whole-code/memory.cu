...
void allocate_memory(int N, int MN, Atom *atom)
{
    ...
    CHECK(cudaMalloc((void**)&atom->g_m, sizeof(double) * N))
    ...
    CHECK(cudaMalloc((void**)&atom->g_vx, sizeof(double) * N))
    CHECK(cudaMalloc((void**)&atom->g_vy, sizeof(double) * N))
    CHECK(cudaMalloc((void**)&atom->g_vz, sizeof(double) * N))
    ...
    CHECK(cudaMalloc((void**)&atom->g_ke, sizeof(double) * N))
