...
| 原子数  | 产出步数   | 求力和数据传输时间的时间 | 运动方程积分的时间  | 全部时间 |
|:----------------|:---------|:-----------|:-----------|:-----------|
| 4000 | 20000 | 5.8 s | 0.7 s  |  6.5 s  |
| 32000 | 10000 | 5.0 s | 2.5 s  |  7.5 s  |
| 108000 | 4000 | 5.4 s | 3.3 s  |  8.7 s  |
| 256000 | 2000 | 5.4 s | 4.6 s  |  10 s  |
